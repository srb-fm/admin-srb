...
class app_config( object ):
    ...
    def __init__(self):
        ...
        self.app_errorslist.append(u"Error 001 bei mp3gain:")
        self.app_errorslist.append(u"Error 002 Fehler beim Kopieren der bearbeiteten Datei ")
...
def audio_mp3gain(ac, path_file):

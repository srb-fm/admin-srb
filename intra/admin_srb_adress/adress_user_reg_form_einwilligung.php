...
<head>
	...
	<title>Admin-SRB-Adresse - Formular Einwilligungserklärung </title>
...
if ( $user_rights == "yes" ) { 		
	echo html_header_srb_print_a("Einwilligungserklärung");
	...
	echo "<div class='content_column_a_3'>" .get_date_format_deutsch($tbl_row->AD_DATUM_GEBURT). "</div>";
	echo "<br>&nbsp;<br>\n";
	...
	echo "<div class='content_column_a_1'>........................................<br> Unterschrift Erziehungsberechtigte/er</div>";

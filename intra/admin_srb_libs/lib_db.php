...
{
	$db_connect = db_connect();
	$db_query = "SELECT A.SG_HF_ID, A.SG_HF_CONTENT_ID, A.SG_HF_TIME, A.SG_HF_DURATION, A.SG_HF_INFOTIME, A.SG_HF_MAGAZINE, A.SG_HF_PODCAST, A.SG_HF_SOURCE_ID, A.SG_HF_FIRST_SG, A.SG_HF_ON_AIR, A.SG_HF_REPEAT_PROTO, A.SG_HF_LIVE, "

...
function read_length_write_tag ( $remotefilename, $pathfilename, $artist , $title, $audio_length_s, $set_mp3gain ){
...
if ( $fp_remote = fopen( $remotefilename, 'rb')) {
   ...
   fclose( $fp_remote );
	...
	// Tags vergleichen
	$need_change_id3 = "no";
	if ( @$ThisFileInfo['playtime_seconds'] != $audio_length_s ){ $need_change_id3 = "yes";  $log_message .= $need_change_id3." playtime/n";}
	if ( @$ThisFileInfo['tags']['id3v2']['title'][0] != $title ){ $need_change_id3 = "yes"; $log_message .= $need_change_id3." title/n";}
	if ( @$ThisFileInfo['tags']['id3v2']['artist'][0] != $artist ){ $need_change_id3 = "yes"; $log_message .= $need_change_id3." artist/n";}
	...
	if ( $need_change_id3 = "yes" ){		
		...
		if ( !copy( $localtempfilename, $pathfilename )) {
   		print ("failed to copy $path_file...<br>\n");
		}
